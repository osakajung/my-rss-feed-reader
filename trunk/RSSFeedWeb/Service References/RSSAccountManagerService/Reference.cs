...
namespace RSSFeedWeb.RSSAccountManagerService {
    ...
    public interface IRssFeedAccountManager {
        ...
        RSSFeedModel.RSSAccountManagerService.USER logOn(string email, string password, RSSFeedWeb.RSSAccountManagerService.ClientType clientId);
    ...
    public partial class RssFeedAccountManagerClient : System.ServiceModel.ClientBase<RSSFeedWeb.RSSAccountManagerService.IRssFeedAccountManager>, RSSFeedWeb.RSSAccountManagerService.IRssFeedAccountManager {
        ...
        public RSSFeedModel.RSSAccountManagerService.USER logOn(string email, string password, RSSFeedWeb.RSSAccountManagerService.ClientType clientId) {
