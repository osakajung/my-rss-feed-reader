        ...
        public long role_id
        {
            ...
            set
            {
                if (_role_id != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'role_id' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _role_id = value;
